...
def main():
    ...
    try:
        ...
        # Move to lower Ground Scan Position
        print("Moving to lower ground position (X=241.0, Y=0.0, Z=80.0)...")
        move_to(lite, 241.0, 0.0, 80.0, 0.0)
        time.sleep(1.0)
        ...
        print("Move the red block around on the table under the camera.")
